...
public interface MasterMindAPI {
	...
	/**
	 * Default method to create a master mind board with the given parameters.
	 * 
	 * @param nrOfPositions Number of positions to guess
	 * @param nrOfColors    Number of colors, each pin can have
	 * @param nrOfMoves     Maximum number of moves, each player may need to guess.
	 * @return
	 */
	static MasterMindAPI of(NrOfHoles nrOfPositions, NrOfColors nrOfColors, NrOfMoves nrOfMoves) {
