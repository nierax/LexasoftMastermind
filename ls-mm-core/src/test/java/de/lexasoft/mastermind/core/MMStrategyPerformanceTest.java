...
class MMStrategyPerformanceTest {
	...
	private static final NrOfColors NR_OF_COLORS = NrOfColors.of(10);
	private static final NrOfHoles NR_OF_HOLES = NrOfHoles.of(6);
	...
	final void testNextGuess() {
		...
		assertEquals(6, result.getNrOfHoles().value(), "The result must have 6 holes.");
